            ...
            if len(movie_matches) == 0:
                ...
                if recommended_movies:
                    ...
                    for i in range(len(recommended_movies)):
                        ...
                        with col1:
                            st.image(recommended_movies_posters[i], width=130)
                        with col2:
                            st.write('**{}**'.format(recommended_movies[i]))
                            st.write('Rating: {}'.format(recommended_movies_ratings[i]))
                            st.write('Overview: {}'.format(recommended_movies_overview[i]))
                else:
